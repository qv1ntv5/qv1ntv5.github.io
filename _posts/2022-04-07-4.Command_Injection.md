...
subtitle: Aplicaciones de la herramienta BurpSuite a la detección de vulnerabilidades de inyección de comandos.
tags: [burp] 
---
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220405105041.png' | relative_url }}" text-align="center"/>
</div>

Y cambiamos el valor del parámetro storeid a ';whoami' para concatenar el comando deseado:

<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220405105122.png' | relative_url }}" text-align="center"/>
</div>

Obteniendo finalmente:

<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220405105140.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220405180238.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220405180536.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220405184126.png' | relative_url }}" text-align="center"/>
</div>
