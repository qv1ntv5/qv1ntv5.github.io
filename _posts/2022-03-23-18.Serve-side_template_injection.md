...
Así, ya sabemos que el motor de la plantilla es Tornado y que se está ejecutando con python 2.7.

Así, buscamos que la forma de introducir una operación matemática en Tornado es mediante la siguiente sintaxis {{}}. Así podemos llevar a cabo una inyección de código de plantilla cerrando la expresión y construyendo otra:
...
Y la sintaxis se cierra sola por la propia incrustación del payload.

Y al comprobar nuestro nombre en los comentarios comprobamos que aparece nuestro nombre de usuario junto con }}49 lo cual delata una posible entrada de datos.

Así, introducimos el siguiente payload

```default
{% import os %} {{os.system('rm /home/carlos/morale.txt')
```

Que codificado adecuadamente quedaría como:
