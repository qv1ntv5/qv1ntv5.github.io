...
subtitle: Aplicaciones de la herramienta BurpSuite a la detección de vulnerabilidades en mecanismos de autenticación.
tags: [burp] 
---
...
- Algo que el cliente **es** como rasgos faciales detectables mediante dispositivos de análisis biométricos (factores inherentes).

<br />

#### 2.2. Diferencias entre la autenticación y la autorización.

La diferencia entre la **autenticación** y la **autorización** es que uno es el proceso de verificación de identidad de un usuario y el otro es el proceso de verificación de permisos de un usuario a la hora de realizar una determinada acción.
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220401113914.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220401114008.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220401120135.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220401120159.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220401120313.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220401162926.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220401171214.png' | relative_url }}" text-align="center"/>
</div>
...
- Para el primer set de payloads, el set del forward de la IP, tenemos:
	...
	<div style="text-align:center">
		<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220401171257.png' | relative_url }}" text-align="center"/>
	</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220401171451.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220401171910.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220401172228.png' | relative_url }}" text-align="center"/>
</div>

Y ahí tenemos las credenciales válidas.

<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220401172313.png' | relative_url }}" text-align="center"/>
</div>
...
- Seguidamente seteamos los conjuntos de payloads de la siguiente manera:
	...
	<div style="text-align:center">
		<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220401175646.png' | relative_url }}" text-align="center"/>
	</div>
	...
	<div style="text-align:center">
		<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220401175530.png' | relative_url }}" text-align="center"/>
	</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220402115510.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220402121047.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220402124913.png' | relative_url }}" text-align="center"/>
</div>

<br />

<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220402125014.png' | relative_url }}" text-align="center"/>
</div>

Y finalmente obtenemos:

<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220402125544.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220402125618.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220406113813.png' | relative_url }}" text-align="center"/>
</div>

Y la mandamos al Intruder: 

<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220406114351.png' | relative_url }}" text-align="center"/>
</div>

Teniendo en cuenta que rellenamos los payloads de la siguiente manera:

<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220406114826.png' | relative_url }}" text-align="center"/>
</div>

<br />

<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220406114853.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220406154645.png' | relative_url }}" text-align="center"/>
</div>

De esta forma, tomamos el nombre y lo ponemos a probar con todas las contraseñas:

<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220406154830.png' | relative_url }}" text-align="center"/>
</div>

Debido a la falla, habrá una, la correcta, que no tendrá mensaje de error aunque esté bloqueada:

<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220406155414.png' | relative_url }}" text-align="center"/>
</div>

De esta manera las credenciales son: alerts:ginger

<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220406155457.png' | relative_url }}" text-align="center"/>
</div>
...
Sin embargo, tiene una falla y es que aunque te rediriga a una página donde hace falta introducir un código de segunda autenticación te logea como usuario sin introducir el código.

Así, introducimos las credenciales de la víctima; carlos:montoya y vamos directamente a /my_account sin necesidad de introducir el código de autenticación.
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220406183828.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220406184217.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220402181201.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220402193854.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220402193940.png' | relative_url }}" text-align="center"/>
</div>
...
- **Reseteo de la password a través de la URL**: Un método más robusto de resetear contraseñas consiste en enviar una URL única al usuario que le envía a la página de reseteo de la contraseña.
	...
	**Laboratorio 11**
	...
	<div style="text-align:center">
		<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220407104312.png' | relative_url }}" text-align="center"/>
	</div>
	...
	<div style="text-align:center">
		<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220407104543.png' | relative_url }}" text-align="center"/>
	</div>
...
- **Reseteo de la password utilizando tokens (APÉNDICE más abajo):** Una mejor implementación del proceso anterior consiste en generar un alto grado de entropía en la request (desorden) de forma que alguien que la lea no sea capaz de descifrar/modificar a qué usuario se le va a cambiar la contraseña.
	...
	**Laboratorio 11**
	...
	Este laboratorio es vulnerable a un "envenenamiento del reseteo de contraseña" (password reset poisoning) Solución más adelante en HTTP Host header attack.
...
- **Cambiando la contraseña**
	...
	**Laboratorio 12**
	...
	<div style="text-align:center">
		<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220407121847.png' | relative_url }}" text-align="center"/>
	</div>
	...
	<div style="text-align:center">
		<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220407130929.png' | relative_url }}" text-align="center"/>
	</div>

	Así, lanzamos la siguiente request
	
	<div style="text-align:center">
		<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220407131132.png' | relative_url }}" text-align="center"/>
	</div>
	...
	<div style="text-align:center">
		<img src="{{ 'assets/img/Burp/ServerTopics/Pasted image 20220407131640.png' | relative_url }}" text-align="center"/>
	</div>


	De forma que las credenciales carlos:michelle.